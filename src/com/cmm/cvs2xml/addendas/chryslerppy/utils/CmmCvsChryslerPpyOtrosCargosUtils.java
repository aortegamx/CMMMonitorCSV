...
import com.cmm.cvs2xml.addendas.chryslerppy.bean.LineaDatosChryslerOtrosCargos;
 ...
 */
public class CmmCvsChryslerPpyOtrosCargosUtils {

    public final static String idRegistro = "00255";
    public final static String infoRegistro = "INFORMACIÓN DE OTROS CARGOS PARA ADDENDA CHRYSLER PPY V1.0";
