 ...
 */
public class CmmCvsChryslerPpyProveedorUtils {

    public final static String idRegistro = "00248";
    public final static String infoRegistro = "INFORMACIÓN DE PROVEEDOR PARA ADDENDA CHRYSLER PPY V1.0";
