...
import com.cmm.cvs2xml.econtabilidad.polizas.bean.PolizasDatos;
                    ...
                    if (polizasDatos.getLineaDatosPolizas().getDatosGeneralesPolizas()!=null){
                        if (polizasDatos.getLineaDatosPolizas().getDatosGeneralesPolizas().getPolizas()!=null){
                                ...
                                if (ultimaPoliza!=null && ultimaTransaccion!=null){
                                    ...
                                    //Registro 125 - Comprobantes
                                    if (line.startsWith(CmmCvsPolizasComprobantesUtil.idRegistro)){
                                        ultimaTransaccion = CmmCvsPolizasComprobantesUtil.fillData(line, ultimaTransaccion);
                                    }
