...
import com.cmm.cvs2xml.addendas.chryslerppy.bean.LineaDatosChryslerCancelaciones;
 ...
 */
public class CmmCvsChryslerPpyCancelacionesUtils {

    public final static String idRegistro = "00246";
    public final static String infoRegistro = "INFORMACIÓN DE CANCELACIONES - REFACTURACION PARA ADDENDA CHRYSLER PPY V1.0";
