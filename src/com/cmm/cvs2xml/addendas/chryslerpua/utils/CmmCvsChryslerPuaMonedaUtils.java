...
import com.cmm.cvs2xml.addendas.chryslerpua.bean.LineaDatosChryslerMoneda;
 ...
 */
public class CmmCvsChryslerPuaMonedaUtils {

    public final static String idRegistro = "00223";
    public final static String infoRegistro = "INFORMACIÓN DE MONEDA PARA ADDENDA CHRYSLER PUA V1.0";
