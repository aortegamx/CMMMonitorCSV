 ...
 */
public class CmmCvsChryslerPuaReceivingUtils {

    public final static String idRegistro = "00227";
    public final static String infoRegistro = "INFORMACIÓN DE RECEIVING PARA ADDENDA CHRYSLER PUA V1.0";
                ...
                switch (x) {
                        ...
                        case 1:
                            ...
                            if (!gc.isValidString(str, 4, 7)){
                                throw new IllegalArgumentException("DATO CÓDIGO DE RECEIVING INCORRECTO, MÍNIMO 4 CARACTERES, MAXIMO 7.");
                            }
                        ...
                        case 2:
                            ...
                            if (!gc.isValidString(str, 1,65)){
                                throw new IllegalArgumentException("DATO NOMBRE DE RECEIVING INCORRECTO, REQUERIDO, DEBE TENER MÍNIMO 1 CARACTERES, MÁXIMO 65.");
                            }
