 ...
 */
public class CmmCvsChryslerPuaDestinoUtils {

    public final static String idRegistro = "00226";
    public final static String infoRegistro = "INFORMACIÓN DE DESTINO PARA ADDENDA CHRYSLER PUA V1.0";
                ...
                switch (x) {
                        ...
                        case 1:
                            ...
                            if (!gc.isValidString(str, 4, 7)){
                                throw new IllegalArgumentException("DATO CÓDIGO DE DESTINO INCORRECTO, MÍNIMO 4 CARACTERES, MAXIMO 7.");
                            }
                        ...
                        case 2:
                            ...
                            if (!gc.isValidString(str, 1,65)){
                                throw new IllegalArgumentException("DATO NOMBRE DE DESTINO INCORRECTO, REQUERIDO, DEBE TENER MÍNIMO 1 CARACTERES, MÁXIMO 65.");
                            }
