...
import mx.bigdata.sat.addenda.chryslerpua.schema.Locacion;
 ...
 */
public class CmmCvsChryslerPuaProveedorUtils {

    public final static String idRegistro = "00224";
    public final static String infoRegistro = "INFORMACIÓN DE PROVEEDOR PARA ADDENDA CHRYSLER PUA V1.0";
            ...
            for (x=0; x < data.length; x++){
                ...
                switch (x) {
                        case 0:
                            ...
                            break;
                        case 1:
                            //Código Proveedor - REQUERIDO
                            if (!gc.isValidString(str, 4, 7)){
                                throw new IllegalArgumentException("DATO CÓDIGO DE PROVEEDOR INCORRECTO, MÍNIMO 4 CARACTERES, MAXIMO 7.");
                            }
                        ...
                        case 2:
                            ...
                            if (!gc.isValidString(str, 1,65)){
                                throw new IllegalArgumentException("DATO NOMBRE DE PROVEEDOR INCORRECTO, REQUERIDO, DEBE TENER MÍNIMO 1 CARACTERES, MÁXIMO 65.");
                            }
                            lineaDatos.setNombre(str);
                            break;
                        case 3:
                            //Sufijo Proveedor - OPCIONAL
