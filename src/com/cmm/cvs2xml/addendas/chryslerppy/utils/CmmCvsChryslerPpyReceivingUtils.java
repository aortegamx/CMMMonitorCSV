 ...
 */
public class CmmCvsChryslerPpyReceivingUtils {

    public final static String idRegistro = "00251";
    public final static String infoRegistro = "INFORMACIÓN DE RECEIVING PARA ADDENDA CHRYSLER PPY V1.0";
