...
import com.cmm.cvs2xml.addendas.chryslerppy.bean.LineaDatosChryslerCargosCreditos;
 ...
 */
public class CmmCvsChryslerPpyCargosCreditosUtils {

    public final static String idRegistro = "00254";
    public final static String infoRegistro = "INFORMACIÓN DE CARGOS CREDITOS PARA ADDENDA CHRYSLER PPY V1.0";
