...
import com.cmm.cvs2xml.addendas.chryslerppy.bean.LineaDatosChryslerGenerales;
 ...
 */
public class CmmCvsChryslerPpyGeneralUtils {

    public final static String idRegistro = "00245";
    public final static String infoRegistro = "INFORMACIÓN DE DATOS GENERALES PARA ADDENDA CHRYSLER PPY V1.0";
            ...
            for (x=0; x < data.length; x++){
                ...
                switch (x) {
                        ...
                        case 1:
                            ...
                            if (!gc.validaConExpresionRegular(str, "PPY")){
                                throw new IllegalArgumentException("DATO TIPO DOCUMENTO INCORRECTO, REQUERIDO, DEBE CORRESPONDER A UNO DE PPY.");
                            }
