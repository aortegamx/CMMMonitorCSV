 ...
 */
public class CmmCvsChryslerPuaOrigenUtils {

    public final static String idRegistro = "00225";
    public final static String infoRegistro = "INFORMACIÓN DE ORIGEN PARA ADDENDA CHRYSLER PUA V1.0";
