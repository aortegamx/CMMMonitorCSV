 ...
 */
public class CmmCvsVwPmtProveedorUtils {

    public final static String idRegistro = "00213";
    public final static String infoRegistro = "INFORMACIÓN DE PROVEEDOR PARA ADDENDA VW PMT V1.0";
                ...
                switch (x) {
                        ...
                        case 1:
                            ...
                            if (!gc.validaConExpresionRegular(str, "^([0-9]{10})$")){
                                throw new IllegalArgumentException("DATO CÓDIGO DE PROVEEDOR INCORRECTO, DEBE SER UN VALOR QUE CORRESPONDA AL PATRÓN [0-9]{10}.");
                            }
                        ...
                        case 2:
                            ...
                            if (StringManage.getValidString(str).length()>0){
                                if (!gc.isValidString(str, 1,35)){
                                    throw new IllegalArgumentException("DATO NOMBRE DE PROVEEDOR INCORRECTO, OPCIONAL, SI SE EXPRESA DEBE TENER MÍNIMO 1 CARACTERES, MÁXIMO 35.");
                                }
